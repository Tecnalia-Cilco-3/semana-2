    ...
    <div class="row justify-content-center mb-5">
      <div class="col-sm-6 col-xs-12 col-lg-4 mt-5">
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">
              Desarrolladores de software fueron muy productivos durante crisis
              de COVID-19
            </h5>
            <p class="card-text">
              Los equipos de desarrolladores de software ser han convertido en
              el ejemplo de cómo deben operar las empresas después de la crisis
              del COVID-19.
            </p>
            <a
      ...
      <div class="col-sm-6 col-xs-12 col-lg-4 mt-5">
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">
              MinTIC busca formar 100.000 programadores para 2025
            </h5>
            <p class="card-text">
